...
public class DijkstraAlgorithm {
	...
	public void execute(Vertex source) {
		...
		while (unSettledNodes.size() > 0) {
			...
			System.out.println("settledNodes " + settledNodes.toString());
			System.out.println("unSettledNodes " + unSettledNodes.toString());
		}

		for (Map.Entry<Vertex, Double> e : distance.entrySet()) {
